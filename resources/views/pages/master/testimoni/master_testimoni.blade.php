...
<div class="container-fluid">
    ...
    <div class="row page-titles mx-0">
        <h2 class="fw-bolder">Testimoni</h1>
        <h5>Gambar-gambar pada Testimoni akan ditampilkan dihalaman utama menjadi slide gambar</h5>
    </div>
        ...
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="media mb-3 align-items-center border-bottom pb-3">
                        ...
                        <div>
                            <a href={{route('masterTestimoniDelete',$data->id)}} class="btn btn-danger btn-sm">Hapus</a>
                        </div>
                    </div>
                    @empty
                ...
                <div>
                    <div class="mb-3">
                        ...
                        <form method="post" action="{{ route('masterTestimoniStore')}}" enctype="multipart/form-data">
                        @csrf
                        <label for="exampleFormControlInput1">Tambah Testimoni</label><br>
                        <div class="container">

                            <img class="img-thumbnail" id="output" src="https://via.placeholder.com/220x220.png?text=Testimoni"/>
                        </div>
                        <br>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="" name="isi" class="form-control">
                        </div>
