                ...
                <div>
                    <div class="mb-3">
                        ...
                        <div class="container">
                            ...
                            <img class="img-thumbnail" id="output" src="https://via.placeholder.com/480x220.png?text=Banner"/>
                        </div>
                        <br>
                        <input onchange="loadFile(event)" type="file" name="foto" class="dropify form-control" id="exampleFormControlInput1" placeholder="">
                        <div id="emailHelp" class="form-text text-danger">File yang diterima : jpeg,png,jpg | Max : 1Mb | Rekomendasi rasio ukuran : 4:3</div>
