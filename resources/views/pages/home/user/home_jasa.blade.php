...
{{-- @if(count($banners)>0) --}}
<div class="section-full bg-gray content-inner vh-80">
    <div class="container mb-sm-5 mb-0">
      <div class="section-full">
          <div class="row py-4">
              <div class="col-xxxl-7 col-xl-7 vh-md-100 pt-7 pb-7 align-items-center d-flex order-2 order-sm-1">
                <div class="">
                  <h2 class="font-45">Expand Your Knowledge & Acheive Your Goal</h2>
              ...
              <div class="col-xxxl-5 col-xl-4 vh-md-100 align-items-center d-flex order-1 order-sm-2">
                  <div class="card w-100 border-0 bg-transparent text-center d-block">
                      <img src="https://images.pexels.com/photos/104827/cat-pet-animal-domestic-104827.jpeg?auto=compress&cs=tinysrgb&w=600" alt="app-bg" class="w-100 rounded-xl os-init" data-aos="zoom-in" data-aos-delay="300" data-aos-duration="500">    
                  </div>
              </div>
          </div>
      </div>
...
{{-- @empty(!$banners)
  <div class="banner-wrapper vh-md-100 layer-after app-shape mb-4">
    <div class="container-fluid">
      <div class="section-full">
        <div class="row">
            <div class="owl-carousel owl-carousel-banner px-0">
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 m-b30 wow bounceInUp" data-wow-duration="2s" data-wow-delay="0.3s">
        <div class="icon-bx-wraper bx-style-1 p-a30 center fly-box bg-white">
          ...
          <div class="icon-content">
            ...
            <a href="" class="site-button btnhover6">Lihat</a>
          </div>
        </div>
      </div>
              ...
              <div class="testimonial-13">
                ...
                <div class="testimonial-detail clearfix">
                  <div class="testimonial-pic radius shadow">
                    <img src="https://asia.ifoam.bio/wp-content/uploads/2018/06/image-placeholder.jpeg'}}" alt="">
                  </div>
                  <h5 class="testimonial-name m-t10 m-b5">Feri</h5> 
