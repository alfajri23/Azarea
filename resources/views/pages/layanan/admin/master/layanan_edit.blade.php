...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{route('layananProgramStoreAdmin')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" value="{{$data->nama}}" class="form-control" id="exampleFormControlInput1" placeholder="">
