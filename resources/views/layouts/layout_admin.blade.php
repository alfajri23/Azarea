        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="ai-icon" href="{{route('layananAdmin')}}" aria-expanded="false">
                    ...
                    <li>
                        <a class="ai-icon" href="{{route('galeriAdmin')}}" aria-expanded="false">
                            <i class="la la-calendar"></i>
                    ...
                    <li>
                        <a class="ai-icon" href="{{route('memberAdmin')}}" aria-expanded="false">
                            <i class="la la-calendar"></i>
                    ...
                    <li>
                        <a class="ai-icon" href="{{route('masterInformasi')}}" aria-expanded="false">
                            <i class="la la-calendar"></i>
					...
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route('masterSosmed')}}">Sosmed</a></li>
                            <li><a href="{{route('masterFAQ')}}">FAQ</a></li>
                        </ul>
                    </li>
